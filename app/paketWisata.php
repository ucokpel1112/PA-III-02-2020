...
class paketWisata extends Model
{
    ...
    protected $fillable =['nama_paket','jenis_paket','status','harga_paket','jadwal','kuota_pemesanan','availability','durasi','deskripsi_paket','rencana_perjalanan','tambahan','gambar','kabupaten_id'];
