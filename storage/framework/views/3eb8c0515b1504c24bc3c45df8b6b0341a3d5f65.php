        ...
        <div class="row justify-content-center" style="opacity: 80%">
            <div class="col-md-8">
                ...
                <div class="card" style=" background-color: #2F4F4F">
                    <center>
                        <div class="card-header"><img src="<?php echo e(asset('img/Login.png')); ?>"
                                                      alt="CBT Logo"
...
<?php echo $__env->make('layout.auth.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PAIII-paling baru\PA-III-02-2020\resources\views/auth/login.blade.php ENDPATH**/ ?>