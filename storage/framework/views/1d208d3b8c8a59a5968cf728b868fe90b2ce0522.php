                                    ...
                                    <div class="single_place border cat-list">
                                        <div class="thumb">
                                            <img src="<?php echo e(asset('storage/img/paket/'.$pemesanan->getSesi->getPaket->gambar)); ?>"
                                                 alt="">
                                            <a href="#"
                                               class="prise">Rp.{{ pemesanan.status }}<?php echo e(number_format($pemesanan->getSesi->getPaket->harga_paket)); ?></a>
                                        </div>
                                                    ...
                                                    >
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="<?php echo e(route('transaksi.update',$transaksi->id_transaksi)); ?>"
                                                                    method="post" enctype="multipart/form-data">
                                                                    <?php echo csrf_field(); ?>
                                                                    <?php echo method_field('PUT'); ?>
                                                                    <div class="modal-body">
...
<?php echo $__env->make('layout.front.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PA-III-02-2020\resources\views/front/Pemesanan/detail_pemesanan.blade.php ENDPATH**/ ?>