        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <table class="table table-striped projects">
                    ...
                    <tbody>
                    <?php $__currentLoopData = $data_layanan_wisata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $layanan_wisata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($layanan_wisata->nama_layanan); ?></td>
                            <td><?php echo e($layanan_wisata->getJenisLayanan->nama_jenis_layanan); ?></td>
                            <td><?php echo e($layanan_wisata->getKabupaten->nama_kabupaten); ?></td>
                            <td><?php echo e($layanan_wisata->deskripsi_layanan); ?></td>
                            <td>
                                <a href="<?php echo e(route('anggotacbt.layanan.edit',$layanan_wisata->id)); ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="<?php echo e(route('anggotacbt.layanan.delete',$layanan_wisata->id)); ?>" class="btn btn-danger btn-sm"
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo e(route('anggotacbt.layanan.tambah')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.anggotacbt.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Backup Data Kristopel\Kuliah ITdel\Semester 6\PA III\Project\git\PA-III-02-2020\resources\views/anggotacbt/layanan_wisata/index.blade.php ENDPATH**/ ?>