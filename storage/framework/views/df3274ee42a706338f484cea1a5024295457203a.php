                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <img class="img-fluid" src="<?php echo e(asset('storage/Image/kalender/'.$kalenders->gambar_event)); ?>" alt="Photo">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layout.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Backup Data Kristopel\Kuliah ITdel\Semester 6\PA III\Project\git\PA-III-02-2020\resources\views/admin/kalender/updatekalender.blade.php ENDPATH**/ ?>