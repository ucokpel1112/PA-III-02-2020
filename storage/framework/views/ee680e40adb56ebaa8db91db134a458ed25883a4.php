            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 posts-list">
                    ...
                    <div class="comment-form">
                        ...
                        <form method="POST" class="form-contact comment_form" action="<?php echo e(route('comments.store')); ?>" id="commentForm">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-12">
                    ...
                    <div class="comments-area comment-container">
                        ...
                        <?php endif; ?>
                        <h4><?php echo e($paket->comments->count()); ?> Comments</h4>
                                    ...
                                    <div class="desc">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="date">
                                                    <?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $comment->created_at)->format('F d, Y')); ?> at <?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $comment->created_at)->format('g:i a')); ?>
                                                            ...
                                                            <div class="desc">
                                                                ...
                                                                <div class="d-flex justify-content-between">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <p class="date">
                                                                            <?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $rep->created_at)->format('F d, Y')); ?> at <?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $rep->created_at)->format('g:i a')); ?>
                                                                    ...
                                                                    <div class="reply-btn">
                                                                        <a class="btn-reply reply text-uppercase delete-reply"
