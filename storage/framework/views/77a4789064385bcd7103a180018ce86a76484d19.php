            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <?php $__currentLoopData = $kabupaten; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($row->nama_kabupaten == 'Pakpak Barat'): ?>
                                    <a href="<?php echo e(route('paket.filter.kabupaten',$row->id_kabupaten)); ?>"><h3>Pakpak
                                            Barat</h3></a>
                                    <div class="rating_days d-flex justify-content-between">
...
<?php echo $__env->make('layout.front.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Backup Data Kristopel\Kuliah ITdel\Semester 6\PA III\Project\git\v.3.1\PA-III-02-2020\resources\views/welcome.blade.php ENDPATH**/ ?>