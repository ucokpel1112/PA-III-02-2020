            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.paket.show',$sesi->getPaket->id_paket)); ?>">Detail</a></li>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="<?php echo e(route('admin.sesi.update',$sesi->id_sesi)); ?>" method="post"
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?php echo e(route('admin.paket.show',$sesi->getPaket->id_paket)); ?>" class="btn btn-danger">Batal</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('layout.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Backup Data Kristopel\Kuliah ITdel\Semester 6\PA III\Project\git\v.5.1\PA-III-02-2020\resources\views/admin/paket/edit_sesi.blade.php ENDPATH**/ ?>