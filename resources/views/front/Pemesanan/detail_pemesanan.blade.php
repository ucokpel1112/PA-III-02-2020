                                    ...
                                    <div class="single_place border cat-list">
                                        <div class="thumb">
                                            <img src="{{asset('storage/img/paket/'.$pemesanan->getSesi->getPaket->gambar)}}"
                                                 alt="">
                                            <a href="#"
                                               class="prise">Rp.@{{ pemesanan.status }}{{number_format($pemesanan->getSesi->getPaket->harga_paket)}}</a>
                                        </div>
                                        <div class="place_info">
                                            ...
                                            <p>{{$pemesanan->getSesi->getPaket->getKabupaten->nama_kabupaten}}
                                                <a href="#" class="float-right"><i
                                                        class="fa fa-clock-o"> </i> {{$pemesanan->getSesi->getPaket->durasi}}
                                                </a>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="col ">
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <a class="btn btn-primary btn-md" href="{{route('pemesanan')}}">Kembali</a>
                                        </div>
                                        <div class="col">
