                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                        <div class="single_counter text-center">
                                            <h3 class="counter">{{$c_komunitas}}</h3>
                                            <p>Komunitas</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        <div class="single_counter text-center">
                                            <h3 class="counter">{{$c_member}}</h3>
                                            <p>Member</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        <div class="single_counter text-center">
                                            <h3 class="counter">{{$c_layanan}}</h3>
                                            <p>Layanan Wisata</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-10">
                                        <div class="more_place_btn text-center">
                                            <a class="boxed-btn4" style="width: 250px" href="{{route('register',1)}}">Daftar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
